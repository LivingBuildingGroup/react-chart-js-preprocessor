...
function LayersOnFly(props) {
  ...
  props.layerUnitsArray.forEach(function (unit) {
    var cbs = props.layersGroupedByUnits[unit].map(function (key) {
      ...
      return /*#__PURE__*/React.createElement("label", {
        ...
        className: "popover"
      }, /*#__PURE__*/React.createElement("p", null, def)));
    });
    layerCheckboxes.push( /*#__PURE__*/React.createElement("div", {
      key: unit,
  ...
  var uncheckAll = /*#__PURE__*/React.createElement("label", {
  ...
  }, uncheckAll, /*#__PURE__*/React.createElement("div", {
